...
export default function Countdown({ datetime }) {
    ...
    return Object.keys(countdown).length ? (
        <div className="countdown-block flex-wrap end">
            ...
            <div className="number-wrapper flex-column center">
                <div className="two-digit centered">{days}</div>
                <span>Дней</span>
            </div>
            <div className="number-wrapper flex-column center">
                <div className="two-digit centered">{hours}</div>
                <span>Часов</span>
            </div>
            <div className="number-wrapper flex-column center">
                <div className="two-digit centered">{minutes}</div>
                <span>Минут</span>
            </div>
            <div className="number-wrapper flex-column center">
