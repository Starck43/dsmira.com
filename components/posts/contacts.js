    ...
    return (
        <section id={section}>
            ...
            <div className="contact">
                ...
                {content.description && (
                    <HtmlContent className="contact-description">{content.description}</HtmlContent>
                )}

                {content.location && (
                    <div className="contact-location">
                        <Location />
                        <HtmlContent>{content.location}</HtmlContent>
                    </div>
                )}
                {content.phone && (
                ...
                {content.www && (
                    <div className="contact-site">
                        <Web />
                        <a href={content.www}>{removeProtocol(content.www)}</a>
                    </div>
                )}
                {content.whatsapp && (
                    <div className="contact-whatsapp">
                        <WhatsApp />
                        <a href={`${WHATSAPP_URL}?phone=${content.whatsapp}`}>whatsapp</a>
                    </div>
                )}
                {content.telegram && (
                    <div className="contact-telegram">
                        <Telegram />
                        <a href={cleanDoubleSlashes(`${TELEGRAM_URL}/${content.telegram}`)}>telegram</a>
                    </div>
                )}
            </div>
        </section>
